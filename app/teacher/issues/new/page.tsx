...
export default function NewTeacherIssuePage() {
  ...
  const [formData, setFormData] = React.useState({
    title: '',
    description: '',
    issue_type: 'student_issue' as 'student_issue' | 'facility_issue' | 'complaint' | 'suggestion' | 'other',
    related_student_id: '',
    ...
    if (admins) {
      for (const admin of admins) {
        await supabase.from('notifications').insert({
          ...
          type: 'alert',
          title: `New Issue: ${formData.title}`,
    ...
    return (
      <div className="max-w-md mx-auto py-16 text-center">
        ...
        <p className="text-muted-foreground mb-6">
          Your issue has been submitted and will be reviewed by administrators.
        </p>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Report an issue to school administration
          </p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* If student issue, select student */}
            {formData.issue_type === 'student_issue' && (
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium">Related Student</label>
                  <Select
